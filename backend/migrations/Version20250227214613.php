 ...
 */
final class Version20250227214613 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F8171EBBD054 FOREIGN KEY (steps_id) REFERENCES quest_step (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
